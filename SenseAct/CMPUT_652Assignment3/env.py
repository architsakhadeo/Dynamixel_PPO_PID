...
class ReacherEnv(gym.core.env):
    ...
    def __init__(self, cycle_time, episode_length, driver, idn, port_str, baud):
        """
    ...
    def read(self):
        ...
        :return:
        """
        read_block = dxl_mx64.MX64.subblock('present_pos', 'goal_pos', ret_dxl_type=driver.is_ctypes_driver)
        observation = dxl.read_vals(self.driver, self.port, 1, read_block)
        return observation
    ...
    def _make_observation(self, dxl_observation: dict):
        ...
        obs = np.array(dxl_observation['present_pos'], dxl_observation['goal_pos'], dxl_observation['present_pos'] - dxl_observation['goal_pos'])
        return obs
